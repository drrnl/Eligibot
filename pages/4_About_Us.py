...
team_members = [
    {"name": "Eric Shen", "role":"Project Lead / Modeling", "image": os.path.join("images","Eric.png"), "caption": "Eric is the Project Lead"},
    ...
    {"name": "Jonathan Luo", "role":"Project Manager / Data Engineer", "image": os.path.join("images","Jonathan.jpeg"), "caption": "I believe that getting the patient community closer to research advances healthcare for all. Through analytics and modeling, I strive to to enable a solution that effectively reforms a field that is people-centric and that I am passionate about."},
    {"name": "Matthew Zhang", "role":"Modeling / AWS Infastructure", "image": os.path.join("images", "Matthew.png"), "caption": "Eric is the Project Lead"},
